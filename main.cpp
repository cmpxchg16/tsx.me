/**
 * Implementation of Naive and Lock-free ring-buffer queues and Intel TSX (Transactional Synchronization Extensions) queue
 ...
 *
 * Copyright (C) 2013-2014 Alexander Krizhanovsky (ak@natsys-lab.com).
